...
#Account for detetion limit using the Rossate Stone
...
write.table(sp.data, file = paste(out.dir,"CWMP_MaxOccV2.csv", sep=""), row.names = FALSE, append = TRUE, col.names=FALSE, quote = FALSE, sep = ",")  
